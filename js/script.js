...
class Usuario {
  ...
  calcularSalarioAnual() {
    ...
    localStorage.setItem('salarioAnualUsuario', this.salarioAnual);
  }
}
...
document.querySelector('.clickA').addEventListener('click', function() {
  ...
  const clickAElement2 = document.querySelector('.clickA2');
document.querySelector('.clickA2').addEventListener('click', function() {
    alert('Haz hecho click en el elemento con clase "clickA2"');
  });

  const clickAElement3 = document.querySelector('.clickA3');
